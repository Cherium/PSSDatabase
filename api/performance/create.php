...
if(
    ...
    if($performance->create()){
        ...
        // tell the user
        echo json_encode(array("message" => "Performance was created."));
    }
    ...
    // if unable to create the product, tell the user
        ...
        // tell the user
        echo json_encode(array("message" => "Unable to create performance. Please check that performance is linked to an existing event. "));
    }
}
