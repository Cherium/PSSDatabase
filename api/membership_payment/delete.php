<?php
    ...
    // delete the product
    if($membership_payment->delete()){
  
        // set response code - 200 ok
        http_response_code(200);
  
        // tell the user
        echo json_encode(array("message" => "Membership_payment was deleted."));
    }
    ...
    // if unable to delete the product
        ...
        // tell the user
        echo json_encode(array("message" => "Unable to delete membership_payment."));
    }
?>